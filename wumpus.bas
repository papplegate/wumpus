Source code for Hunt the Wumpus by Gregory Yob, retyped from People's Computer Company (1977), What to Do After You Hit Return: A Computer Games Book from People's Computer Company, Hayden Book Company
...
4070 IF S[L[1], K]=1 THEN 4130
4080 NEXT K
4090 IF K=L[1] THEN 4130
4080 NEXT K
...
4200 RETURN
4210 REM-PIT
4220 IF L#L[3] AND L#L[4] THEN 4279
